...
const IncompleteTaskModel = ({ item, changeStatusHandler, deleteHandler }) => {
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <AntDesign
              onPress={() =>
                changeStatusHandler(item.item._id, item.item.title)
              }
              name="checkcircleo"
              size={20}
              color="green"
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <AntDesign
              ...
              size={20}
              color="red"
              onPress={() => deleteHandler(item.item._id, item.item.title, 1)}
            />
          </View>
        </TouchableOpacity>
      </View>
...
export default IncompleteTaskModel;
